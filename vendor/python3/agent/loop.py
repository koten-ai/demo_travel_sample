...
from python3.agent.audit import run_runtime_contract_audit
from python3.agent.hooks import AgentHooks
from python3.agent.session_phase import commit_session_turn, setup_contract_and_session
from python3.agent.tool_round import execute_tool_calls, run_llm_round
from python3.constants import MAX_ROUNDS, normalize_api_version
from python3.llm.client import cache_hints
from python3.logging_setup import logger
from python3.toon import _toon_encode
from python3.zeus.auth import resolve_zeus_auth
from python3.zeus.catalog import apply_injected_business_logic, load_chat_request
...
async def setup_turn_context(
    ...
    if chat_req.get("_normalized_from_verbs") or chat_req.get("_format"):
        trace["notes"].append(
